...
class TestModelLoading(unittest.TestCase):
    ...
    def test_load_model_auto_config(self, mock_model_from_pretrained, mock_processor_from_pretrained, mock_get_optimal_config):
        # Arrange
    ...
    @patch('vibevoice.model.VibeVoiceProcessor.from_pretrained')
    @patch('vibevoice.model.VibeVoiceForConditionalGenerationInference.from_pretrained')
    def test_load_model_explicit_args(self, mock_model_from_pretrained, mock_processor_from_pretrained, mock_get_optimal_config):
        # Arrange
        mock_model = MagicMock()
        mock_processor = MagicMock()
        mock_model_from_pretrained.return_value = mock_model
