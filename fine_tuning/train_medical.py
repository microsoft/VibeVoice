...
Usage:
    ...
    python train_medical.py --epochs 3 --batch_size 4 --lr 2e-4
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune medical LLM")
    ...
    print("\n" + "="*60)
    print("VEMI AI Medical LLM Fine-Tuning")
    print("="*60)
...
{example['output']}<|im_end|>"""
    ...
    # Merge and save full model (optional, uses more disk space)
